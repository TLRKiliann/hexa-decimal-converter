...
import CompHexadecimalDecimal from '../CompHexadecimalDecimal.tsx'
import LabelInputComponent from "../CompHexadecimalDecimal.tsx"
...
test('handleClick should update the result', () => {
  const { getByText, getByTestId } = render(<CompHexadecimalDecimal />);
